...
<section>
  <form action="index.php?page=mnt_piano" method="post">
    ...
    <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="number" id="pianosales" name="pianosales" placeholder="Ventas" value="{{pianosales}}" />
      {{if error_pianosales}}
    ...
    <fieldset>
      <label for="pianoimguri">Imagen URL: </label>
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="pianoimguri" name="pianoimguri" placeholder="Imagen URL" value="{{pianoimguri}}" />
    ...
    <fieldset>
      <label for="pianoimgthb">Imagen thb URL: </label>
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="pianoimgthb" name="pianoimgthb" placeholder="Imagen thb URL" value="{{pianoimgthb}}" />
