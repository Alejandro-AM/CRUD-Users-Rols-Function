  ...
  <header>
    ...
    <nav id="menu">
      <ul>
        ...
        {{endfor NAVIGATION}}
        <li><a href="index.php?page=Admin_Usuarios"><i class="fas fa-sign-out-alt"></i>&nbsp;Usuarios</a></li>
        <li><a href="index.php?page=Admin_Funciones"><i class="fas fa-sign-out-alt"></i>&nbsp;Funciones</a></li>
        <li><a href="index.php?page=Admin_Roles"><i class="fas fa-sign-out-alt"></i>&nbsp;Roles</a></li>
